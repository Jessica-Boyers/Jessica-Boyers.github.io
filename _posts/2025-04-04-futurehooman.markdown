...
images:
  - path: Door model.png
    alt: ""
    caption: "Game Cabinet Model"
  - path: Receptacle.png
    alt: ""
    caption: "Receptacle and Piece Model, showing motor"
  - path: circuits.png
    alt: ""
    caption: "Motor control circuit (left) and power distribution control circuit (right)"
  - path: lights.jpg
    alt: ""
    caption: "Lighting circuit and control"
  - path: doorvideo.mp4
    alt: ""
